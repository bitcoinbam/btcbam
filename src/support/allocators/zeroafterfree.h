...
#ifndef BITCOINBAM_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BITCOINBAM_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BITCOINBAM_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
