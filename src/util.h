 ...
 */
#ifndef BITCOINBAM_UTIL_H
#define BITCOINBAM_UTIL_H
...
extern const char * const BITCOINBAM_CONF_FILENAME;
extern const char * const BITCOINBAM_PID_FILENAME;
...
{
    std::string s = strprintf("bitcoinbam-%s", name);
