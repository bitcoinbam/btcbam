...
#ifndef BITCOINBAM_INTERFACES_NODE_H
#define BITCOINBAM_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoinbam node (bitcoinbamd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITCOINBAM_INTERFACES_NODE_H
