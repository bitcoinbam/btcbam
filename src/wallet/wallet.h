...
#ifndef BITCOINBAM_WALLET_WALLET_H
#define BITCOINBAM_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinbam node, and set to 0 for transactions that were created
...
#endif // BITCOINBAM_WALLET_WALLET_H
