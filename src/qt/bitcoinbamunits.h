...
#ifndef BITCOINBAM_QT_BITCOINBAMUNITS_H
#define BITCOINBAM_QT_BITCOINBAMUNITS_H
...
/** BitcoinBam unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitcoinBamUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitcoinBamUnits(QObject *parent);

    /** BitcoinBam units.
      @note Source: https://en.bitcoinbam.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTCBAM,
...
typedef BitcoinBamUnits::Unit BitcoinBamUnit;

#endif // BITCOINBAM_QT_BITCOINBAMUNITS_H
