    ...
    mapper(0)
{
    ...
    ui->bitcoinbamAtStartup->setToolTip(ui->bitcoinbamAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bitcoinbamAtStartup->setText(ui->bitcoinbamAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openBitcoinBamConfButton->setToolTip(ui->openBitcoinBamConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BitcoinBamUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoinbamAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitcoinBamConfButton_clicked()
{
