...
#ifndef BITCOINBAM_KEYSTORE_H
#define BITCOINBAM_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/bitcoinbam/bips/blob/master/bip-0013.mediawiki
