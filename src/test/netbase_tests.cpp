...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinbamcore.org", "www.bitcoinbamcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoinbamcore.org]", "www.bitcoinbamcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoinbamcore.org:80", "www.bitcoinbamcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinbamcore.org]:80", "www.bitcoinbamcore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:23182", "127.0.0.1", 23182));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:23182", "127.0.0.1", 23182));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:23182", "::ffff:127.0.0.1", 23182));
    BOOST_CHECK(TestSplitHost("[::]:23182", "::", 23182));
    BOOST_CHECK(TestSplitHost("::23182", "::23182", -1));
    BOOST_CHECK(TestSplitHost(":23182", "", 23182));
    BOOST_CHECK(TestSplitHost("[]:23182", "", 23182));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:23182", "127.0.0.1:23182"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:23182", "[::]:23182"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
