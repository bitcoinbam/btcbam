...
#ifndef BITCOINBAM_TEST_SCRIPTNUM10_H
#define BITCOINBAM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitcoinBam Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINBAM_TEST_BIGNUM_H
