BitcoinBam Core version 0.17.1 is now available from:

  <https://bitcoinbamcore.org/bin/bitcoinbam-core-0.17.1/>
...
Please report bugs using the issue tracker at GitHub:
  ...
  <https://github.com/bitcoinbam/bitcoinbam/issues>

To receive security and update notifications, please subscribe to:

  <https://bitcoinbamcore.org/en/list/announcements/join/>
...
installer (on Windows) or just copy over `/Applications/BitcoinBam-Qt` (on Mac)
or `bitcoinbamd`/`bitcoinbam-qt` (on Linux).
...
BitcoinBam Core is extensively tested on multiple operating systems using
the Linux kernel, macOS 10.10+, and Windows 7 and newer (Windows XP is not supported).

BitcoinBam Core should also work on most other Unix-like systems but is not
...
When bitcoinbam is configured with the `-deprecatedrpc=accounts` setting, specifying
...
- #14698 `ec71f06` Add bitcoinbam-tx.exe into Windows installer (ken2812221)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/bitcoinbam/).
