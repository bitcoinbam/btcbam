...
This document provides guidelines for internationalization of the BitcoinBam Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinbam_en.ts` remains unchanged.
