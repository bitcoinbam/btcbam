...
* bitcoinbam.conf: contains configuration settings for bitcoinbamd or bitcoinbam-qt
* bitcoinbamd.pid: stores the process id of bitcoinbamd while running
...
* debug.log: contains debug information and general logging generated by bitcoinbamd or bitcoinbam-qt
