...
"""Verify that starting bitcoinbam with -h works as expected."""

from test_framework.test_framework import BitcoinBamTestFramework
from test_framework.util import assert_equal

class HelpTest(BitcoinBamTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinbam with -h for help text")
        ...
        self.log.info("Start bitcoinbam with -version for version information")
        ...
        self.log.info("Start bitcoinbamd with -fakearg to make sure it does not start")
