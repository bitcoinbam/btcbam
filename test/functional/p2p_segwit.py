...
class SegWitTest(BitcoinBamTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older bitcoinbamd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let bitcoinbamd fill it in.
