...
# TestP2PConn: A peer we use to send messages to bitcoinbamd, and store responses.
...
class CompactBlocksTest(BitcoinBamTestFramework):
    ...
    # This test actually causes bitcoinbamd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bitcoinbamd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcoinbamd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcoinbamd will not send blocktxn responses for blocks whose height is
