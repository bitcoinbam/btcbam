...
class InvalidTxRequestTest(BitcoinBamTestFramework):
    ...
    def run_test(self):
        ...
        tx1 = create_tx_with_script(block1.vtx[0], 0, script_sig=b'\x64' * 35, amount=26 * COIN - 12000)
        ...
        tx_withhold.vout.append(CTxOut(nValue=26 * COIN - 12000, scriptPubKey=SCRIPT_PUB_KEY_OP_TRUE))
